...
<style>
    ...
    /* 👉 Remets ici tout le reste de ton CSS existant */
</style>
...
def transcrire_audio(audio_bytes):
    try:
        ...
        response = model.generate_content(
            [
                "Transcris exactement en français. Si silence, réponds '...'", 
...
def afficher_footer():
    st.markdown(
        '<div class="footer">@croquison Création pédagogique 2025 - Tous droits réservés</div>',
        unsafe_allow_html=True
    )
